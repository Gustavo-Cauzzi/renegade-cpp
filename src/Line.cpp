...
Line::Line(SDL_Surface * window_surface, SDL_Renderer * pRenderer, Point start, Point end, Color color) {
    this->start = start;
    this->end = end;
    this->color = color;
...
Line::Line(SDL_Surface * window_surface, SDL_Renderer * pRenderer, Point start, Point end, Color color, int antialias) {
    this->start = start;
    this->end = end;
    this->color = color;
